...
const stats = [
  {
    value: "#1",
    fr: "Réseau EV structuré",
    en: "Structured EV network",
    sub_fr: "En Côte d'Ivoire",
    sub_en: "In Côte d'Ivoire",
  ...
  },
  {
    ...
    fr: "Marchés",
    en: "Markets",
    sub_fr: "Potentiel continental",
    sub_en: "Continental potential",
    color: "oklch(0.62 0.19 220)",
  },
  {
    value: "100%",
