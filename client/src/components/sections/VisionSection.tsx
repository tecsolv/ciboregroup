...
const stats = [
  {
    ...
    en: "Deployment year",
    desc_fr:
      "Les premiers sites partenaires CIBORE entrent en phase de sélection active.",
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(oklch(0.62 0.19 220) 1px, transparent 1px), linear-gradient(90deg, oklch(0.62 0.19 220) 1px, transparent 1px)",
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to right, transparent, oklch(0.62 0.19 220 / 30%), transparent)",
        }}
      />
    </section>
  );
