...
const phases = [
  {
    ...
    desc_fr:
      "Définition du modèle d'infrastructure, positionnement de marque et architecture du réseau.",
    desc_en:
      "Infrastructure model definition, brand positioning and network architecture.",
  },
  {
    icon: Clock,
    status: "active",
    ...
    desc_fr:
      "Identification et qualification des premiers sites stratégiques en Côte d'Ivoire.",
    desc_en:
      "Identification and qualification of the first strategic sites in Côte d'Ivoire.",
  },
  {
    icon: MapPin,
    status: "upcoming",
    ...
    desc_fr:
      "Installation de l'infrastructure CIBORE sur les sites partenaires sélectionnés.",
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to right, transparent, oklch(0.73 0.12 75 / 30%), transparent)",
        }}
      />
                      ...
                      <div className="flex-1 pb-8">
                        ...
                        <p
                          style={{
                            ...
                            color:
                              isDone || isActive
                                ? "oklch(0.68 0.008 240)"
                                : "oklch(0.35 0.008 240)",
                            lineHeight: 1.6,
                          }}
                        >
