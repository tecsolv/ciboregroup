...
const pillars = [
  {
    ...
    en: "Smart cities",
    desc_fr:
      "Des métropoles africaines connectées, durables et orientées vers l'avenir.",
  ...
  },
  {
    ...
    desc_fr:
      "L'électrification de la mobilité comme levier de développement continental.",
    desc_en:
      "The electrification of mobility as a lever for continental development.",
  },
  {
    fr: "Transport du futur",
    en: "Future transportation",
    desc_fr:
      "Des réseaux de mobilité premium qui redéfinissent le déplacement en Afrique.",
    desc_en:
      "Premium mobility networks that redefine transportation in Africa.",
  },
  {
    fr: "Évolution urbaine africaine",
    en: "African urban evolution",
    desc_fr:
      "Une nouvelle génération de villes africaines, modernes et ambitieuses.",
    ...
    >
      ...
      <div className="relative h-[60vh] md:h-[70vh] overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, oklch(0.07 0.008 240 / 30%) 0%, oklch(0.07 0.008 240 / 60%) 60%, oklch(0.07 0.008 240) 100%)",
          }}
        />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(to bottom, transparent 60%, oklch(0.07 0.008 240 / 80%) 100%)",
                }}
              />
