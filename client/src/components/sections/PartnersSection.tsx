...
const audiences = [
  { icon: TrendingUp, fr: 'Investisseurs', en: 'Investors', fr_sub: 'Fonds d\'infrastructure', en_sub: 'Infrastructure funds' },
  { icon: Building, fr: 'Hôtels & Resorts', en: 'Hotels & Resorts', fr_sub: 'Destinations premium', en_sub: 'Premium destinations' },
  { icon: Globe, fr: 'Gouvernements', en: 'Governments', fr_sub: 'Partenaires institutionnels', en_sub: 'Institutional partners' },
  { icon: Users, fr: 'Promoteurs immobiliers', en: 'Real estate developers', fr_sub: 'Résidences & bureaux', en_sub: 'Residences & offices' },
  { icon: Shield, fr: 'Entreprises énergétiques', en: 'Energy companies', fr_sub: 'Partenaires stratégiques', en_sub: 'Strategic partners' },
  { icon: Leaf, fr: 'Constructeurs EV', en: 'EV manufacturers', fr_sub: 'Écosystème mobilité', en_sub: 'Mobility ecosystem' },
];
...
const credentials = [
  {
    fr: 'Structuré',
    en: 'Structured',
    desc_fr: 'Une approche méthodique et institutionnelle du déploiement d\'infrastructure.',
    desc_en: 'A methodical and institutional approach to infrastructure deployment.',
  },
  {
    fr: 'Scalable',
    en: 'Scalable',
    desc_fr: 'Un modèle conçu pour s\'étendre de la Côte d\'Ivoire à l\'ensemble du continent.',
    desc_en: 'A model designed to expand from Côte d\'Ivoire to the entire continent.',
  },
  {
    fr: 'Future-proof',
    en: 'Future-proof',
    desc_fr: 'Une infrastructure pensée pour les 20 prochaines années de mobilité africaine.',
    desc_en: 'Infrastructure designed for the next 20 years of African mobility.',
  },
  {
    fr: 'Institutionnel',
    en: 'Institutional-grade',
    desc_fr: 'Standards internationaux, crédibilité locale, vision continentale.',
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(circle, oklch(0.73 0.12 75) 0%, transparent 70%)',
          filter: 'blur(80px)',
        }}
      />
      ...
      <div className="container relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-end">
            ...
            >
              {lang === 'fr' ? (
                <>
                  Partenaires &<br />
                  <em style={{ color: 'oklch(0.73 0.12 75)', fontStyle: 'italic' }}>investisseurs.</em>
                </>
              ) : (
                <>
                  Partners &<br />
                  <em style={{ color: 'oklch(0.73 0.12 75)', fontStyle: 'italic' }}>investors.</em>
                </>
              )}
            </h2>
            <p
        ...
        >
          ...
          >
            {lang === 'fr' ? 'Nos interlocuteurs stratégiques' : 'Our strategic stakeholders'}
          </p>
          ...
          >
            <p
                ...
                <button
                  ...
                  className="btn-gold"
                >
                  {lang === 'fr' ? 'Demander un dossier investisseur' : 'Request an investor dossier'}
                </button>
          </div>
        </div>
      </div>
