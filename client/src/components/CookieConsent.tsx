    ...
    >
      ...
      {showDetails && (
        ...
        >
          ...
          >
            ...
            {" — "}
            {t(
              "Nécessaires au fonctionnement du site. Impossible de les désactiver.",
              "Necessary for the site to function. Cannot be disabled.",
            )}
          </p>
          <p
            style={{
          ...
          >
            ...
            {" — "}
            {t(
              "Données anonymes sur la navigation. Aucune donnée personnelle collectée.",
              "Anonymous navigation data. No personal data collected.",
            )}
          </p>
          <p
            style={{
      ...
      <div style={{ display: "flex", gap: "8px" }}>
        ...
        <button
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.color = "oklch(0.75 0.005 240)";
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.borderColor = "oklch(1 0 0 / 10%)";
            e.currentTarget.style.color = "oklch(0.55 0.008 240)";
          }}
        >
      ...
      >
        <a
          ...
          style={{ color: "oklch(0.45 0.008 240)", textDecoration: "none" }}
        >
          {t("Politique de confidentialité", "Privacy Policy")}
        </a>
        {" · "}
        <a
          href="https://cibore.ci"
          target="_blank"
