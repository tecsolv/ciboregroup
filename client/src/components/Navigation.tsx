  ...
  return (
    <>
            ...
            <div className="hidden lg:flex items-center gap-8">
              {navLinks.map((link) => (
                <button
                  ...
                  onMouseEnter={(e) =>
                    (e.currentTarget.style.color = "oklch(0.97 0.003 240)")
                  }
                  onMouseLeave={(e) =>
              ...
              <div className="flex items-center gap-1">
                <button
                  ...
                  className={`font-ui text-xs font-500 tracking-wider uppercase transition-all duration-200 px-2 py-1 ${
                    lang === "fr" ? "text-white" : "opacity-40 hover:opacity-70"
                  }`}
                ...
                <button
                  onClick={() => setLang("en")}
                  className={`font-ui text-xs font-500 tracking-wider uppercase transition-all duration-200 px-2 py-1 ${
                    lang === "en" ? "text-white" : "opacity-40 hover:opacity-70"
                  }`}
                  style={{ fontSize: "0.6875rem", letterSpacing: "0.1em" }}
                >
                  EN
      ...
      <div
        ...
        style={{
          background: "oklch(0.07 0.008 240 / 98%)",
