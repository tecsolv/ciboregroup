...
export default function Footer() {
  ...
  return (
    <footer
      className="relative"
      style={{
        background: "oklch(0.70 0.005 240)",
    ...
    >
      ...
      <div className="container py-16 md:py-20">
        <div className="grid md:grid-cols-3 gap-12 md:gap-16">
              ...
              {navLinks.map((link) => (
                <li key={link.href}>
                  <button
                    ...
                    onMouseLeave={(e) =>
                      (e.currentTarget.style.color = "oklch(0.65 0.008 240)")
                    }
                  >
          ...
          {/* Contact & CTA */}
          <div>
            <p className="section-label mb-6">{t("Contact", "Contact")}</p>
            <div className="space-y-3 mb-8">
              ...
              <a
                href="https://linkedin.com/company/cibore"
                target="_blank"
      ...
      <div style={{ borderTop: "1px solid oklch(1 0 0 / 5%)" }}>
        <div className="container py-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            >
              {t(
                "CIBORE Group Ltd — Registered in England & Wales, UK",
                "CIBORE Group Ltd — Registered in England & Wales, UK",
              )}
            </p>
            <p
            ...
            >
              {t(
                "Fondé par José ETTIEN, entrepreneur ivoirien d'ancrage international.",
                "Founded by José ETTIEN, Ivorian entrepreneur with international anchoring.",
              )}
            </p>
            <p
              style={{
            ...
            >
              {t(
                "L'infrastructure de la mobilité africaine.",
                "The infrastructure of African mobility.",
              )}
            </p>
          </div>
        </div>
