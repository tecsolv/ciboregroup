    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          zIndex: 99999,
          boxShadow: '0 24px 64px rgba(0,0,0,0.7), 0 0 0 1px oklch(0.73 0.12 75 / 10%)',
      ...
      >
        ...
        <div style={{
          ...
          height: '2px',
          background: 'linear-gradient(90deg, transparent, oklch(0.73 0.12 75), transparent)',
          borderRadius: '2px',
        }}/>
        ...
        <button
          ...
          onMouseEnter={e => {
            (e.currentTarget as HTMLButtonElement).style.background = 'oklch(0.73 0.12 75 / 20%)';
            (e.currentTarget as HTMLButtonElement).style.color = 'oklch(0.73 0.12 75)';
          }}
          onMouseLeave={e => {
            (e.currentTarget as HTMLButtonElement).style.background = 'oklch(0.20 0.015 200)';
            (e.currentTarget as HTMLButtonElement).style.color = 'oklch(0.65 0.008 240)';
          }}
        >
          ✕
        </button>
        ...
        <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap', alignItems: 'center' }}>
          ...
          <button
            ...
            onMouseEnter={e => {
              (e.currentTarget as HTMLButtonElement).style.background = 'oklch(0.80 0.12 75)';
              (e.currentTarget as HTMLButtonElement).style.transform = 'translateY(-1px)';
            }}
            onMouseLeave={e => {
              (e.currentTarget as HTMLButtonElement).style.background = 'oklch(0.73 0.12 75)';
          ...
          <button
            ...
            onMouseEnter={e => {
              (e.currentTarget as HTMLButtonElement).style.borderColor = 'oklch(0.73 0.12 75 / 40%)';
              (e.currentTarget as HTMLButtonElement).style.color = 'oklch(0.85 0.005 240)';
            }}
            onMouseLeave={e => {
              (e.currentTarget as HTMLButtonElement).style.borderColor = 'oklch(0.35 0.015 200)';
              (e.currentTarget as HTMLButtonElement).style.color = 'oklch(0.70 0.008 240)';
            }}
          >
